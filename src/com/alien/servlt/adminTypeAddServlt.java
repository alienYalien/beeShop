 ...
 */
@WebServlet("/myAdmin/typeAdd")
public class adminTypeAddServlt extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(tMgr.typeAdd(new type(name))) {
			request.setAttribute("msg", "type add succes!");
		}else {
			request.setAttribute("failMsg", "type name repeat!");
		}
