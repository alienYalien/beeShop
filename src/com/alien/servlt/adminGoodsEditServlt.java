 ...
 */
@WebServlet("/myAdmin/goodsEdit")
public class adminGoodsEditServlt extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			gService.update(g);
			request.getRequestDispatcher("/myAdmin/goodsList?pageNo="+pageNo+"&type="+type).forward(request, response);
