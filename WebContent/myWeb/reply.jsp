		...
		<div class="contact-medile-section">
			<div class="container"> 
			 	<div class="contact  bg-bd">
			 		<div class="r-y-w">
						<a href="${pageContext.request.contextPath }/myWeb/goodsList">
							<p>  《《  返回继续购物</p>
						</a>						
					</div>
				 	<div class="form-area"> 
			 			<form action="${pageContext.request.contextPath }/myWeb/goodsReplyCommit" method="post">
				 			<div class="row"> 
				 				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				 					<p class="sent-hed">回复</p>
				 					<input type="hidden" name="id" value="${id }">
				 					<c:if test="${!empty replyMsg }">
				 						<label><strong>${replyMsg }</strong></label>
				 					</c:if>
									<p>回复 @ ${name }</p>
