    ...
    <body class="check-out-page">
		...
		<div class="container"> 
			 	<div class="contact  bg-bd">
				 	...
				 	<div class="form-area"> 
			 			<form action="${pageContext.request.contextPath }/myWeb/goodsCommentCommit" method="post">
				 			<div class="row"> 
				 				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
				 					<p class="sent-hed">评价</p>
				 					<input type="hidden" name="id" value="${id }">
				 					<c:if test="${!empty commentMsg }">
				 						<label><strong>${commentMsg }</strong></label>
				 					</c:if>
									<p>商品名称 ：${name }</p>
